...
objCmd.ActiveConnection = "Provider=SQLOLEDB.1;Password=sample;Persist Security Info=True;User ID=sample;Initial Catalog=sample;Data Source=(local)"

'[2]CommnadText 속성에 넣을 Command의 종류를 설정(기본값 : 8(adCmdUnknown))
objCmd.CommandType = 8

'[3]Command 문자열을 설정.
objCmd.CommandText = "Select * From my_memo"

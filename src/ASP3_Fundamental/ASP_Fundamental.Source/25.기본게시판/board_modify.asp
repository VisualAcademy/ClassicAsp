...
'SQL문 생성
strSQL = "Select * From my_board Where Num = " & Num
...
<div align="center">
<table border="1">
<form action="./board_modify_process.asp" method="Post" name="WriteForm" OnSubmit="return check();">

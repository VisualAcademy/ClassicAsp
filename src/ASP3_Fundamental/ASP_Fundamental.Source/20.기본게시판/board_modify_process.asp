...
' Program Name : board_modify_process.asp
...
If objRS.Fields("Passwd") = Passwd Then
	'데이터베이스 처리(수정) 구문 작성
	strSQL2 = "Update my_board Set Name = '" & Name & "', Email = '" & Email & "', Title = '" & Title & "', ModifyDate = '" & ModifyDate & "', Encoding = '" & Encoding & "', ModifyIP = '" & ModifyIP & "', Content = '" & Content & "' Where Num = " & Num

...
' Program Name : upload_write_form.asp
' Program Description : 폼태그를 이용한 자료실에 업로드
' Include Files : None
...
<div align="center">
<table border="1">
<form action="./upload_write_process.asp" method="Post" name="WriteForm" OnSubmit="return check();" enctype="multipart/form-data">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemoList.aspx.cs" Inherits="MemoList" %>
...
<body>
    ...
    <div>
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            CellPadding="4" DataKeyNames="Num" DataSourceID="SqlDataSource1" GridLines="Horizontal">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:abcConnectionString %>"
            ...
            OnSelecting="SqlDataSource1_Selecting" SelectCommand="SELECT * FROM [Memos] ORDER BY [Num] DESC"
            UpdateCommand="UPDATE [Memos] SET [Name] = @Name, [Email] = @Email, [Title] = @Title, [PostDate] = @PostDate, [PostIP] = @PostIP WHERE [Num] = @Num">
            <DeleteParameters>
        ...
        &nbsp;<asp:FormView ID="FormView1" runat="server" BackColor="White" BorderColor="#999999"
            BorderStyle="None" BorderWidth="1px" CellPadding="3" DataKeyNames="Num" DataSourceID="SqlDataSource1"
            DefaultMode="Insert" GridLines="Vertical">

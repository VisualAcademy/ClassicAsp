...
//       KeyFile을 지정하는 경우, KeyFile의 위치는
//        "프로젝트 출력 디렉터리"를 기준으로 하는 상대 위치여야 합니다. 프로젝트 출력 디렉터리의
//        위치는 로컬 또는 웹 프로젝트에 따라 다릅니다.
//        로컬 프로젝트의 경우, 프로젝트 출력 디렉터리는
//       <Project Directory>\obj\<Configuration>과 같이 정의됩니다. 예를 들어, KeyFile이 프로젝트 디렉터리에 있는 경우
//       AssemblyKeyFile 특성을 
//       [assembly: AssemblyKeyFile("..\\..\\mykey.snk")]로 정의합니다.
//        웹 프로젝트의 경우, 프로젝트 출력 디렉터리는
//       %HOMEPATH%\VSWebCache\<Machine Name>\<Project Directory>\obj\<Configuration>으로 정의됩니다.
